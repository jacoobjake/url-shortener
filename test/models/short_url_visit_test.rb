...
class ShortUrlVisitTest < ActiveSupport::TestCase
  ...
  test "is valid with a 2-character country_code" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), country_code: "US")
    assert visit.valid?
  end

  test "is invalid with a country_code not equal to 2 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), country_code: "USA")
    assert_not visit.valid?
  ...
  test "is invalid with a 1-character country_code" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), country_code: "U")
    assert_not visit.valid?
    assert_includes visit.errors[:country_code], "is the wrong length (should be 2 characters)"
  end

  test "is valid with a nil region_code" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), region_code: nil)
    assert visit.valid?
  end

  test "is valid with a region_code up to 10 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), region_code: "CA")
    assert visit.valid?
  end

  test "is invalid with a region_code longer than 10 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), region_code: "A" * 11)
    assert_not visit.valid?
  ...
  test "is invalid with a country_name longer than 100 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), country_name: "A" * 101)
    assert_not visit.valid?
  ...
  test "is invalid with a region_name longer than 100 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), region_name: "A" * 101)
    assert_not visit.valid?
  ...
  test "is invalid with a city longer than 100 characters" do
    visit = ShortUrlVisit.new(short_url: short_urls(:github), city: "A" * 101)
    assert_not visit.valid?
